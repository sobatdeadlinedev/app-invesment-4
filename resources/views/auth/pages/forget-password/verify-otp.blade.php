...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #countdown { font-family: var(--mono); font-weight: 700; color: var(--green-dark); }
...
<body id="kt_body" class="app-blank">
    ...
    <div class="page-wrap">
        <div class="phone-shell">
            ...
            <div class="top-bar">
                <a href="{{ route('forget-password') }}" class="back-btn" aria-label="Back">
            ...
            <div class="hero">
                ...
                <div class="hero-copy">
                    <h1>Verify OTP</h1>
                    <p>Enter the 6-digit code sent to<br><strong>{{ session('reset_email') }}</strong></p>
                </div>
            </div>
            ...
            <div class="register-box">
                ...
                <form method="POST" action="{{ route('verify-otp.post') }}" id="otpForm">
                    ...
                    <div class="otp-notice">
                        ...
                        <div>
                            <div class="otp-notice-title">OTP Expires In <span id="countdown">10:00</span></div>
                            <div class="otp-notice-msg">Please verify your code before it expires for security purposes.</div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updateTimer() {
            ...
            if (seconds > 0) {
                ...
                countdownEl.style.color = '#E5484D';
            }
        }
