...
<<<<<<< HEAD
    <title>hitech54idn</title>
=======
    <title>Hi Tech Exchange</title>
>>>>>>> dev
    ...
    <style>
        ...
        * {
        ...
        .stat-cell-value.cyan {
            color: var(--gold-color);
        }

        .stat-cell-value.green {
            color: #22c55e;
        }
